...
@section('main-content')
 ...
 <div class="mad-breadcrumb">
    <div class="container">
      <h1 class="mad-page-title mad-title-with-line">Shop</h1>
      <nav class="mad-breadcrumb-path"><span><a href={{route('landingPage')}}>Home</a></span>/<span>Shop</span>
      </nav>
    </div>
  </div>
  <!--================ End of Breadcrumb ================-->
          ...
          <div class="row mad-row-size-3">
            <main id="main" class="col-xl-12 col-lg-11">
              ...
              <div role="alert" class="mad-alert-box mad-alert-box--error">
                <div class="mad-alert-box-inner">{{ session('status')}}

...
@section('main-content')
 ...
 <div class="mad-breadcrumb">
    <div class="container">
      <h1 class="mad-page-title mad-title-with-line">Shop By {{$subcategory->subcategory_name}}</h1>
      <nav class="mad-breadcrumb-path"><span><a href={{route('landingPage')}}>Home</a></span>/<span>Shop By {{$subcategory->subcategory_name}}</span>
      </nav>
    </div>
  </div>
  <!--================ End of Breadcrumb ================-->

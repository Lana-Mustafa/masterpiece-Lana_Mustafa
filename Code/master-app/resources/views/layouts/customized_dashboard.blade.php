...
<body class="">
  ...
  <div class="wrapper ">
    ...
    -->
      <div class="logo">
        <a href={{route('supplier.dashboard')}} class="simple-text logo-mini">
          <i class="material-icons"> dashboard</i>
        </a>
        <a href={{route('supplier.dashboard')}} class="simple-text logo-normal">
           Dashboard
        </a>
      </div>
      <div class="sidebar-wrapper">
        ...
        <div class="user nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="{{route('supplier.changepassword')}}">
        ...
        <ul class="nav">
          <li class="nav-item  ">
            <a class="nav-link" data-toggle="collapse" href="#MangeProduct">
              <i class="material-icons">dashboard_customize</i>
              <p> Manage Products 
                <b class="caret"></b>
              </p>
            </a>
            <div class="collapse" id="MangeProduct">
                <ul class="nav">
                  <li class="nav-item ">
                    <a class="nav-link" href={{route('supplierproducts.index')}}>
                      <span class="sidebar-mini"> P </span>
                      <span class="sidebar-normal"> My Products </span>
                    </a>
                  </li>
                  <li class="nav-item ">
                    <a class="nav-link" href={{route('supplierproducts.create')}}>
            ...
            <ul class="navbar-nav"> 
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  <a class="dropdown-item" href={{route('supplier.profile')}}>EditProfile</a>
                  <a class="dropdown-item" href={{route('supplier.changepassword')}}>Change Password</a>
